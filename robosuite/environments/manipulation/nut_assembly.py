...
from robosuite.models.objects import SquareNutObject, RoundNutObject, BoxObject
...
class NutAssembly(SingleArmEnv):
    ...
    def _load_model(self):
        ...
        if self.patch_attack:
            ...
            bin_x_half = mujoco_arena.table_full_size[0] / 2 - 0.05
            bin_y_half = mujoco_arena.table_full_size[1] / 2 - 0.05
            self.placement_initializer.append_sampler(
                sampler=UniformRandomSampler(
        ...
        self.model = ManipulationTask(
            ...
            mujoco_objects=self.nuts + extra_objs,
        )
