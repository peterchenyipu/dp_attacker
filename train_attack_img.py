...
from diffusion_policy.workspace.train_adversary_workspace import TrainAdversarialNoiseWorkspace
...
@hydra.main(
    ...
    config_path=str(pathlib.Path(__file__).parent.joinpath(
        'attack_configs','train_attack_config'))
)
def main(cfg: OmegaConf):
    ...
    workspace: TrainAdversarialNoiseWorkspace = TrainAdversarialNoiseWorkspace(workspace_cfg, run_config=cfg)
